...
export default function App() {
  return <main className="world">
    ...
    {/* This HUD gives the intro a game-world identity; change its labels to match your specialty. */}
    <div className="world-hud container"><span>PLAYER: YOUR NAME</span><span>BIOME: GAME DEVELOPMENT</span><span>MODE: OPEN TO WORK</span></div>
